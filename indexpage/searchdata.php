      ...
      <div class="row-fluid">
        <div class="span2">
          <div class="dashboard-wid-wrap" style="width:100%;">
           <div class="dashboard-wid-content"> <a href="ajax _addclient/index.php"><img src="addstudent.png" width="40"> <span class="dasboard-icon-title"><b>Search Client</b></span> </a> </div>
          
          </div>
        </div>
        <div class="span2">
          <div class="dashboard-wid-wrap">
           <div class="dashboard-wid-content"> <a href="ajax _addBook/index.php"><img src="addbook.jpg" width="40"> <span class="dasboard-icon-title"><b>Add Book</b></span> </a> </div>
         </div>
        </div>
        <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _addstaff/index.php"> <img src="addstaff.png" width="40"> <span class="dasboard-icon-title"><b>Search Staff</b></span> </a> </div>
          </div>
        </div>
       
	    <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _penalty/index.php"> <img src="penalty.jpg"width="40"> <span class="dasboard-icon-title"><b>Penalty Student</b></span> </a> </div>
          </div>
        </div>
       
	<div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _addnotify/index.php"> <img src="notification.jpg" width="40"> <span class="dasboard-icon-title"><b>Notification students</b></span> </a> </div>
          </div>
        </div>
        ...
        <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _addinventory/index.php"><img src="addinventory.png" width="40"> <span class="dasboard-icon-title"><b>Search Inventory</b> </span> </a> </div>
          </div>
        </div>
        <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _addDonar/index.php"> <img src="adddonar.png" width="55"> <span class="dasboard-icon-title"><b>Search donar</b></span> </a> </div>
          </div>
        </div>
        <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="upload_and_delete_file/upload.php">  <img src="addedata.png" width="30">  <span class="dasboard-icon-title"><b>Search eData</b></span> </a> </div>
          </div>
        </div>
		 <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _addbook_issue-return_data/index.php"><img src="bookreturn.jpg" width="39"> <span class="dasboard-icon-title"><b>Book Return data</b></span> </a> </div>
          </div>
        </div>
       
		 <div class="span2">
          <div class="dashboard-wid-wrap">
            <div class="dashboard-wid-content"> <a href="ajax _addtop3projects/index.php"> <img src="addtop3projects.jpg" width="60"> <span class="dasboard-icon-title"><b>Search Top 3 Proj</b></span> </a> </div>
          </div>
        </div>
