...
if(isset($_POST["search"]["value"]))
{
 ...
 OR kgsofmaterial LIKE "%'.$_POST["search"]["value"].'%" 
 ';
}
...
{
 $sub_array = array();
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="itemid">' . $row["itemid"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="typeofmaterial">' . $row["typeofmaterial"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="kgsofmaterial">' . $row["kgsofmaterial"] . '</div>';
