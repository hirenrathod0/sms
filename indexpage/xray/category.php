...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO rep_cat_xray (name,price) VALUES (%s,%s)",
                       GetSQLValueString($_POST['fname'], "text"),GetSQLValueString($_POST['price'], "text"));
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-title">
          <h1> Add New Lab Report Category </h1>
          <ol class="breadcrumb">
                  ...
                  <form method="POST" name="form1" action="<?php echo $editFormAction; ?>" id="f1">
                    <table align="center" class="table-responsive table-condensed table-bordered table ">
                      <tr valign="baseline">
                        ...
                        <td><input type="text" name="fname" value="" size="32" placeholder="Enter Category Name " required class="form-control" onblur="makeupper(this.id);" id="fname"></td>
                      </tr>
					<tr valign="baseline">
          ...
          <div class="col-lg-12">
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
				...
				<?php 
					mysql_select_db($database_cn, $cn);
					$query_Recordset1 = "SELECT * FROM rep_cat_xray";
                      ...
                      <tr>
                       <td><?php  echo $i;?></td>
						...
						<td><?php echo $row_Recordset1['price']; ?></td>
						 <td><a href="editcat.php?bid=<?php echo $row_Recordset1['rid']; ?>" class="btn-blue btn"> <i class="fa fa-hospital-o">  </i> </a> </td>
						  <td><a href="delcat.php?rid=<?php echo $row_Recordset1['rid']; ?>" class="btn-red btn"> <i class="fa fa-power-off">  </i> </a> </td>
					</tr>
                      <?php $i++;} while ($row_Recordset1 = mysql_fetch_array($Recordset1)); ?>
					  </tbody>
                  </table>
				  <?php } else {  ?>
