                    ...
                    <tbody>
                      <?php $i=1; do {
						 $bb=$row_Recordset2['pid'];
						  mysql_select_db($database_cn, $cn);
$query_rs_pdtl = "SELECT patient.fname, patient.mname, patient.lname, patient.city, patient.gender  FROM patient where pid='$bb'";
...
$totalRows_rs_pdtl = mysql_num_rows($rs_pdtl); ?>
                        <tr>
                          ...
                          <td width="25%"><?php
 mysql_select_db($database_cn, $cn);
$query_Recordset21 = "SELECT * FROM xray_dtl where pid='$bb'";
