                  ...
                  <div class="portlet-body">
                        <form ACTION="forgetpassword.php" METHOD="POST" name="forpass" >
							...
							<?php if(isset($_POST['recover'])){?>
                          	<?php if($n==1) { ?>
						    <h6 align="center"><strong class=" alert alert-success " >Password Recovered Succsesfully</strong></h6>
							<br/>
							<a href="login.php" style="font-size:12px;color:#0000FF;float:right">Back to login</a>
                         	<?php }	if ($n==0) { ?>
							<H6 align="center" class="text-red"><strong class="alert alert-danger">Sorry Invalid Email ID Please Try Again</strong></H6>
							<?php } ?>
						<?php	}?>
						<br>
						<br> 
                               ...
                               <br/>
								<input type="submit"  class="btn btn-lg btn-green btn-block" name="recover" value="Recover My Password"/>
								<br/>
