...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "updateuserpic")) {
  ...
  $updateSQL = sprintf("UPDATE user SET img=%s WHERE uid=%s",
          ...
          <div class="portlet-body">
            ...
            <div id="userTabContent" class="tab-content">
              <div class="tab-pane fade in active" id="overview">
                <div class="row">
                  <div class="col-lg-2 col-md-3"> <a href=""><img class="img-responsive img-profile" src="userpic/<?php echo $row_useroverview_rs['img']; ?>" alt=""></a> </div>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <ul id="userSettings" class="nav nav-pills nav-stacked">
                      ...
                      <li><a href="#profilePicture" data-toggle="tab"><i class="fa fa-picture-o fa-fw"></i> Profile Picture</a> </li>
                        ...
                        <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="updateuser">
                          ...
                          <table align="center" class="table-responsive table-condensed table-bordered table ">
                            <div class="form-group">
                              <tr valign="baseline">
                                <td nowrap align="left"><label>Full Name</label></td>
                                <td><input type="text" name="fullname"  id="fnm"onblur="makeupper(this.id);" class="form-control" value="<?php echo $row_useroverview_rs['fullname']; ?>"></td>
                              </tr>
                            </div>
                            <tr valign="baseline">
                              <td nowrap align="left"><div class="form-group">
                                  <label for="exampleInputEmail1">Gender </label>
                                </div></td>
                              <td><input type="radio" name="gender" value="MALE" <?php if((strcmp($row_useroverview_rs['gender'],"MALE"))){ echo 'CHECKED'; } ?> />
                                MALE
                                <input type="radio" name="gender" Value="FEMALE" <?php if((strcmp($row_useroverview_rs['gender'],"FEMALE"))){ echo 'CHECKED'; } ?> />
                                FEMALE</td>
                            </tr>
                            <tr valign="baseline">
                              <td nowrap align="left"><label>BirthDate</label></td>
                              <td><input type="date" name="birthdate" id="bdt"onblur="makeupper(this.id);" class="form-control" value="<?php echo $row_useroverview_rs['birthdate']; ?>"></td>
                            </tr>
                            <tr valign="baseline">
                              <td nowrap align="left"><label>Address</label></td>
                              <td><textarea name="address" class="form-control" cols="15" id="add"onblur="makeupper(this.id);" rows="3"><?php echo $row_useroverview_rs['address']; ?></textarea></td>
                            </tr>
                            <tr valign="baseline">
                              <td nowrap align="left"><label>City</label></td>
                              <td><input type="text" name="city" id="city"onblur="makeupper(this.id);" class="form-control" value="<?php echo $row_useroverview_rs['city']; ?>"></td>
                            </tr>
                             <tr valign="baseline">
                              <td nowrap align="center" colspan="2"><h4>Contact Details:</h4></td>
                            </tr>
                            <tr valign="baseline">
                              <td nowrap align="left">
                                <label><i class="fa fa-envelope-o fa-fw"></i> Contact</label>
							  </td>
                              <td><input type="text" class="form-control" name="contact" value="<?php echo $row_useroverview_rs['contact']; ?>"></td>
                            </tr>
                            
                            
                            <tr valign="baseline">
                              <td nowrap align="left"><label><i class="fa fa-envelope-o fa-fw"></i> Email</label></td>
                              <td><input type="email" class="form-control" id="email"onblur="makeupper(this.id);" name="email" value="<?php echo $row_useroverview_rs['email']; ?>"></td>
                            </tr>
                            <tr valign="baseline">
                            
                            <td nowrap align="left"><label for="exampleInputEmail1">Select Type</label></td>
                            <td>
...
?>
                            ...
                            <tr valign="baseline">
                              <td nowrap align="center" colspan="2"><button type="submit" class="btn btn-default">Update Profile</button>
                                <button class="btn btn-green">Cancel</button></td>
                            </tr>
                          </table>
                      ...
                      <div class="tab-pane fade" id="profilePicture">
                        ...
                        <img class="img-responsive img-profile" src="userpic/<?php echo $row_useroverview_rs['img']; ?>" alt="" height="300" width="300"> <br>
                        <form action="<?php echo $editFormAction; ?>" role="form" method="POST" name="updateuserpic" enctype="multipart/form-data">
                          <div class="form-group">
                            <input type="hidden" name="id"  value="<?php echo $row_useroverview_rs['uid']; ?>" />
                          ...
                          <input type="hidden" name="MM_update" value="updateuserpic">
                        </form>
                      </div>
                      <div class="tab-pane fade in" id="changePassword">
                        ...
                        <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                          <table align="center">
                            <tr valign="baseline">
                              ...
                              <td><input type="text" class="form-control" name="username" value="<?php echo $row_Recordset1['username']; ?>" size="32"></td>
                            </tr>
                            <tr valign="baseline">
                        ...
                        <a href="viewuser.php?removeuserauth=<?php echo $_GET['id'] ?>" class="btn btn-larger btn-red">Delete Authanticate</a>
                        <?php } else { ?>
