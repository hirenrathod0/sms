...
if ((isset($_GET['remove'])) && ($_GET['remove'] != "")) {
  $deleteSQL = sprintf("DELETE FROM usercategory WHERE id=%s",
...
mysql_select_db($database_cn, $cn);
$query_usercat_list_rs = "SELECT * FROM usercategory ORDER BY id DESC";
        ...
        <div class="portlet portlet-default">
          <div class="portlet-heading">
            <div class="portlet-title">
              <h5>Add User/Employee Category</h5>
            </div>
              ...
              <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="usercat">
                <table align="center" class="table-responsive table-condensed table-bordered table ">
                  <div class="form-group">
                    <tr>
                      <td><label for="exampleInputEmail1">User Category</label></td>
                      <td><input type="text" class="form-control" name="cat" required="required" onblur="makeupper(this.id);" id="exampleInputEmail1"  placeholder="User/Employee Category Eg. Lab"></td>
                    </tr>
                  </div>
                  <tr>
      ...
      <form name="listcat" >
        <div class="col-lg-7">
          <div class="portlet portlet-default">
            <div class="portlet-heading">
              <div class="portlet-title">
                <h5>List User/Employee Category</h5>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="portlet-body">
                  ...
                  <tbody>
                    <?php $i=1; do { ?>
                      <tr>
                        ...
                        <td><a class="btn btn-orange" href="edituser.php?id=<?php echo $row_usercat_list_rs['id']; ?>"><i class="fa fa-edit"> </i></a>&nbsp;&nbsp;<a class="btn btn-danger" href="usercat.php?remove=<?php echo $row_usercat_list_rs['id']; ?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-times"> </i></a></td>
                      </tr>
