...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO case_fee (name, price) VALUES (%s, %s)",
...
mysql_select_db($database_cn, $cn);
$query_Recordset1 = "SELECT * FROM case_fee";
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h5 style="float:left">Add New Charges  </h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h5 style="float:left"> All Report Category </h5>
                    ...
                    <?php do { ?>
                      <tr>
						...
						<td><?php echo $row_Recordset1['price']; ?></td>
						 <td><a href="editcase.php?id=<?php echo $row_Recordset1['id']; ?>" class="btn btn-warning"> <i class="fa fa-edit"> </i> </a>&nbsp;<a href="delcase.php?id=<?php echo $row_Recordset1['id']; ?>"onClick="return confirm('Are you sure you want to delete this record?')" class="btn-red btn"> <i class="fa fa-power-off"> </i> </a> </td>
					</tr>
