...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "adduser")) {
  $updateSQL = sprintf("UPDATE usercategory SET name=%s WHERE id=%s",
...
mysql_select_db($database_cn, $cn);
$query_Recordset1 = sprintf("SELECT * FROM usercategory WHERE id = %s", $colname_Recordset1);
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  <form method="POST" action="<?php echo $editFormAction; ?>"  name="adduser" enctype="multipart/form-data" >
                    ...
                    <tr valign="baseline">
                      <td nowrap align="left"><strong> User  Category :</strong></td>
                      <td><input type="text" class="form-control" name="cate" onblur="makeupper(this.id);" id="exampleInputEmail1" placeholder="Enter User  Category" value="<?php echo $row_Recordset1['name']; ?>"></td>
                    </tr>
