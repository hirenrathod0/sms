...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE case_fee SET name=%s, price=%s WHERE id=%s",
...
mysql_select_db($database_cn, $cn);
$query_Recordset1 = sprintf("SELECT * FROM case_fee WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h4 style="float:left"> Edit Charges </h4>
                  ...
                  <form method="POST" name="form1" action="<?php echo $editFormAction; ?>" id="f1">
                    <table align="center" class="table-responsive table-condensed table-bordered table ">
                      <tr valign="baseline">
                        ...
                        <td><input type="text" name="fname" value="<?php echo $row_Recordset1['name']; ?>" size="32" placeholder="Enter Category Name " required class="form-control"  id="fname"></td>
                      </tr>
					  <tr valign="baseline">
