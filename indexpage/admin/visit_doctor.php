...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "fcat")) {
  $insertSQL = sprintf("INSERT INTO doctor_chg (dnm, chg) VALUES (%s, %s)",
...
mysql_select_db($database_cn, $cn);
$query_getlist = "SELECT * FROM doctor_chg";
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-title">
          <h4>Doctor Visit   <small>Charges</small> </h4>
                    ...
                    <table align="center" class="table-responsive table-condensed table-bordered table ">
                      <div class="form-group">
                        <tr valign="baseline">
                          ...
                          <td><input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Doctor Name" onblur="makeupper(this.id);" required name="dnm"  /></td>
                      </div>
                      ...
                      <div class="form-group">
                        <tr valign="baseline">
                          ...
                          <td><input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Doctor Charges" onblur="makeupper(this.id);" required name="chg"  /></td>
                      </div>
                  ...
                  <tbody>
                    <?php $k=0; do { ?>
                      <tr>
                        ...
                        <td><a href="edit_doc.php?id=<?php echo $row_getlist['id']; ?>" class="btn btn-info"><i class="fa fa-edit"> </i></a>
