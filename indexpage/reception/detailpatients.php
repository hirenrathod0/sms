        ...
        <?php  echo "  
            <div class='portlet portlet-default'>
              <div class='portlet-heading'>
                ...
                <div class='portlet-widgets' class='pull-right'> <a href='editpatient.php?id=$recordID'  class='btn btn-orange'   ><i class='fa fa-edit'></i></a> <button class='btn btn-danger' data-dismiss='modal' aria-hidden='true'><i class='fa fa-times'></i></button></div>
