...
mysql_select_db($database_cn, $cn);
 $query_Recordset3 = "SELECT pid FROM xray WHERE fname = '$fn' and lname='$ln' and contactno1='$mno' ";
...
echo $insertSQL = sprintf("INSERT INTO xray (pid, fname, mname, lname, bdate, city, contactno1, contactno2, emailid, gender, bgroup, iden_no, iden_type, religion, `state`, smoker, tobacco, alcohol, pincode, height, weight, adds, remark, mnm, gnm) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_cn, $cn);
$query_Recordset2 = "SELECT pid FROM xray ORDER BY pid DESC";
      ...
      <div class="col-lg-12">
        <div class="page-title">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Add New X-Ray </li>
          </ol>
        </div>
      </div>
      <!-- /.col-lg-12 -->
          ...
          <div class="col-lg-12">
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                ...
                <div class="portlet-widgets"> <a href="all_xray.php"  class="pull-right btn-orange btn "   > All X-Ray Data </a>   </div>
