...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO refund_dtl (pid, catename, depo_amt,depo_date) VALUES (%s, %s, %s, %s)",
      ...
      <div class="col-lg-12">	
        <div class="page-title">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Add New Deposit </li>
          </ol>
        </div>
      </div>
      <!-- /.col-lg-12 -->
                  ...
                  <form method="POST" name="form1" action="<?php echo $editFormAction; ?>" id="f1">
                    <table align="center" class="table-responsive table-condensed table-bordered table ">
                      <tr valign="baseline">
                        ...
                        <td nowrap ><strong>Deposit Type:</strong></td>
                        <td>
					  ...
					  <tr valign="baseline">
                       ...
                       <tr valign="baseline">
                        ...
                        <td><input type="date" name="ddate" value="" size="30" class="form-control" placeholder="dd-mm-yy"></td>
                        </tr>
