...
<table  class="body" id="customers" border="1" style="padding:5px;border:solid" cellspacing="-1"  align="center">
  ...
  <?php $total=0; do { ?>
    <tr style="alignment-adjust:central">
      <td colspan="2"><?php echo 'ECG' ?></td>
      <td align="center"><?php 
	  
	  mysql_select_db($database_cn, $cn);
 $query_Recordset11 = "SELECT * FROM fee where name='ECG'";
...
$totalRows_Recordset11 = mysql_num_rows($Recordset11);
	  $zz=$row_Recordset11['price'];
	  
	  echo $row_Recordset11['price'];
    ...
    <?php } while (@$row_Recordset1 = mysql_fetch_assoc($row_Recordset1)); ?>
  <!-- </td>
        </tr>
      </table> -->
  <tr>
    <td colspan="2" align="right">Total</td>
    <td colspan="1" align="right"><?php echo $zz; ?></td>
  </tr>
  </td>
  ...
  <tr >
    <td colspan="4"> Recieved with thanks from <strong>
      ...
      Rs <strong><?php echo $zz; ?></strong> The Sum Of Rs <strong><?php echo convert_number_to_words($zz); ?></strong> </td>
  </tr>
  <tr>
