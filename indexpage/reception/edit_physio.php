...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE physio SET fname=%s, mname=%s, lname=%s, bdate=%s, city=%s, contactno1=%s, contactno2=%s, emailid=%s, gender=%s,adds=%s,state=%s,pincode=%s,height=%s,weight=%s,religion=%s,iden_no=%s,iden_type=%s,smoker=%s,tobacco=%s,alcohol=%s,remark=%s,mnm=%s,gnm=%s WHERE pid=%s",
...
mysql_select_db($database_cn, $cn);
$query_Recordset1 = sprintf("SELECT * FROM  physio WHERE pid = %s", $colname_Recordset1);
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-title">
              <h1> Edit Physio Details </h1>
              <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i> <a href="index.php">Dashboard</a> </li>
                <li class="active"> Edit Physio Details </li>
              </ol>
            </div>
          </div>
          <!-- /.col-lg-12 --> 
                ...
                <div class="portlet portlet-default">
                  <div class="portlet-heading">
                    <div class="portlet-title">
                      <h4 style="float:left"> Edit Physio Details </h4>
                    </div>
                    <div class="portlet-widgets"> <a href="all_ physio.php"  class="pull-right btn-orange btn "   > All Physio Data </a> </div>
...
?>
                          ...
                          <tr valign="baseline">
                            <td nowrap colspan="4"><strong> Smoker:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              ...
                              <input <?php if (!(strcmp($row_Recordset1['alcohol'],"on"))) {echo "checked=\"checked\"";} ?> name="alcohol" type="checkbox"  ></td>
                          </tr>
                          <tr valign="baseline" >
