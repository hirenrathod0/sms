    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-title">
          <h1> Current Queue Of Dr Pankaj Parikh  </h1>
          <ol class="breadcrumb">
...
mysql_select_db($database_cn, $cn);
$query_Recordset2 = "SELECT booking.pid,booking.bid,patient.fname,patient.mname,patient.lname,patient.pid,patient.city FROM booking inner join patient WHERE date(bdt) = CURDATE() and status='ACTIVE' and docid='1' limit 1";
...
$n= date('d-m-Y');
mysql_select_db($database_cn, $cn);
 $query_getctime = "SELECT * FROM appointment WHERE timeofapp = '$start' and dateofapp='$n' and did='1'";
...
patient.fname,patient.mname,patient.lname,patient.pid,patient.city FROM booking inner join patient WHERE date(bdt) = CURDATE() and status='ACTIVE' and docid='1'  and booking.bid='$bid' and booking.pid=patient.pid ";
