...
mysql_select_db($database_cn, $cn);
 $query_patient = sprintf("SELECT * FROM labs WHERE pid = %s", GetSQLValueString($colname_patient, "int"));
...
<table  class="body" id="customers" border="1" style="padding:5px;border:solid" cellspacing="-1"  align="center">
  ...
  <tr>
    <td >Bill NO:-<?php echo $row_bill['bid']; ?></td>
    <td>Date:- <?php echo date('d/m/y',strtotime($row_bill['date']));?></td>
  </tr>
   <tr>
