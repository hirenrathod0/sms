...
if (isset($_GET['aid'])) {
  $colname_Recordset2 = (get_magic_quotes_gpc()) ? $_GET['aid'] : addslashes($_GET['aid']);
}
mysql_select_db($database_cn, $cn);
$query_Recordset2 = sprintf("SELECT * FROM appointment WHERE aid = %s", $colname_Recordset2);
...
function sendit()
{
   var sdate4=document.getElementById('sdate').value; 
	  ...
	  var aid4=document.getElementById('aid').value;
   
 var dd=new Array(sdate4,stime4,did4,aid4);
sessionStorage.setItem('myvalue', JSON.stringify(dd));
 window.location='updateapp.php?aid='+aid4;
...
<div class="row">
  <div class="col-lg-12">
    <div class="page-title">
      <h1>
        <?php echo $row_getdoctor['fullname']; ?>
        &nbsp; Appointment&nbsp;Status </h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> <a href="index.php">Dashboard</a> </li>
		
        <li class="active">Update Time</li>
      </ol>
    </div>
  </div>
  <div class="col-lg-12">
    <div class="portlet portlet-default">
      <div class="portlet-heading">
        <div class="portlet-title">
          <h4 style="float:left"> Update Appointment Timings </h4> 
        </div>
        <div class="portlet-widgets" style=""><div>Appointment Date : <?php echo $row_Recordset2['dateofapp']; ?>  & Time : <?php echo $row_Recordset2['timeofapp']; ?><a href="#" onclick="sendit()" class="btn btn-primary btn-small pull-right" id='sbmt' style="display:none;" > Next</a>
		  </div>
          <ul id="myPortletTab" class="list-inline tabbed-portlets" style="float:left">
