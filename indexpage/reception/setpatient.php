...
echo   $insertSQL = sprintf("INSERT INTO appointment (did,dateofapp,timeofapp,pname,pvillage, pcontactno) VALUES (%s,%s,%s,%s,%s,%s)",
                       GetSQLValueString($_POST['did1'], "text"),
					   GetSQLValueString($_POST['sdate1'], "text"),
					   GetSQLValueString($_POST['stime1'], "text"),
					   GetSQLValueString($_POST['fname'], "text"),
                       GetSQLValueString($_POST['city3'], "text"),
                       GetSQLValueString($_POST['contactno13'], "text"));
          ...
          <div class="tab-pane fade in active" id="tab1">
			...
			<div id="replace">
			 ...
			 <td nowrap align="right"><strong>Selected Time:</strong></td>
			   <td>  <input type="text"  name="stime1" id="stime1"  style="background-color:#FFFFFF;border:none" readonly/></td>
			 </tr>
			  
			          <tr valign="baseline">
					  <td nowrap align="right"><strong>Full Name:</strong></td>
					  <?php  if(isset($_GET['pid'])) { $g=($row_Recordset1['fname'] .' '.$row_Recordset1['mname'].' '. $row_Recordset1['lname']); ?>
            
			            
      
		                <td><input type="text" name="fname" value="<?php echo $g; ?>" style="width:42%" placeholder="Enter First Name " required class="form-control" onblur="makeupper(this.id);" onkeyup="getdetail(this.value)" id="fname"><div  id="id4" style="position:absolute;top:53%;left:45.5%;"></div></td>
					 ...
					 {
					 ?>
					  <td><input type="text" name="fname" value="" style="width:42%" placeholder="Enter First Name " required class="form-control" onblur="makeupper(this.id);" onkeyup="getdetail(this.value)" id="fname"><div  id="id4" style="position:absolute;top:53%;left:45.5%;"></div></td>
					 <?php
					 }
					 ?>
                      </tr>
                      <tr valign="baseline">
                        ...
                        <td><input type="text" name="city3" onblur="makeupper(this.id);" value="<?php echo $row_Recordset1['city']; ?>" style="width:42%" placeholder="Enter City"  class="form-control" id="city" required></td>
                      </tr>
                      <tr valign="baseline">
                        <td nowrap align="right"> <strong>Primary Contact No :</strong></td>
                        <td><input type="number" name="contactno13" value="<?php echo $row_Recordset1['contactno1']; ?>"  style="width:42%" placeholder=" Primary Contact No"  class="form-control" id="contactno1" required></td>
                      </tr>
...
var dd = JSON.parse(sessionStorage.getItem('myvalue'));
  ...
  // document.getElementById('br1').attr('href','settime.php');
	 document.getElementById("br1").href="settime.php?did="+g; 
