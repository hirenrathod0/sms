...
$query_Recordset1 = "SELECT booking.pid, patient.fname,patient.mname,patient.lname,patient.bdate,patient.city,patient.gender  FROM booking inner join patient where date(bdt)=CURDATE()  and booking.pid=patient.pid";
                    ...
                    <tbody>
                      <?php $i=1; do{  ?>
                        <tr>
                          ...
                          <td><a href="genbill.php?pid=<?php echo $row_Recordset1['pid']; ?>" class="btn btn-info"><i class="fa fa-paperclip">Generate Bill</i></a></td>
                        </tr>
