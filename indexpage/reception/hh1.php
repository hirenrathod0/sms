...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO xray (pid, fname, mname, lname, bdate, city, contactno1, contactno2, emailid, gender, bgroup, iden_no, iden_type, religion, `state`, smoker, tobacco, alcohol, pincode, height, weight, adds, remark, nmn, gnm) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
?>
                      ...
                      <tr valign="baseline">
                        <td nowrap colspan="4"><strong> Smoker:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input <?php if (!(strcmp($row_Recordset1['smoker'],"on"))) {echo "checked=\"checked\"";} ?> name="smoker" type="checkbox"  class="form-control"  >
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong> Tobacco:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input <?php if (!(strcmp($row_Recordset1['tobacco'],"on"))) {echo "checked=\"checked\"";} ?> name="tobacco" type="checkbox"  class="form-control"  />  
                          ...
                          <input <?php if (!(strcmp($row_Recordset1['alcohol'],"on"))) {echo "checked=\"checked\"";} ?> name="alcohol" type="checkbox"  class="form-control" ]
