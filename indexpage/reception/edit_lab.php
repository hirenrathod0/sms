...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE labs SET fname=%s, mname=%s, lname=%s, bdate=%s, city=%s, contactno1=%s, contactno2=%s, emailid=%s, gender=%s,adds=%s,state=%s,pincode=%s,height=%s,weight=%s,religion=%s,iden_no=%s,iden_type=%s,smoker=%s,tobacco=%s,alcohol=%s,remark=%s,mnm=%s,gnm=%s WHERE pid=%s",
...
mysql_select_db($database_cn, $cn);
$query_Recordset1 = sprintf("SELECT * FROM labs WHERE pid = %s", $colname_Recordset1);
      ...
      <div class="col-lg-12">
        <div class="page-title">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Edit Lab Details </li>
          </ol>
        </div>
      </div>
      <!-- /.col-lg-12 -->
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h4 style="float:left"> Edit Lab Details </h4>
                </div>
                <div class="portlet-widgets"> <a href="all_lab.php"  class="pull-right btn-orange btn "   > All Lab </a> </div>
