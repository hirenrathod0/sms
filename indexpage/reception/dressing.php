...
$query_Recordset2 = "SELECT * FROM dressing";
                ...
                <div class="portlet-body">
                  ...
                  <table id="example-table" class="table table-striped table-bordered table-hover table-green table-condensed"  >
                    ...
                    <tbody>
                      <?php $i=1; do {
						mysql_select_db($database_cn, $cn);
						$kk=$row_Recordset2['pid'];
$query_Recordset1 = "SELECT * FROM patient WHERE pid = '$kk'";
$Recordset1 = mysql_query($query_Recordset1, $cn) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1); ?>
                      <tr>
					  <td><?php echo $row_Recordset1['pid']; ?></td>
              <td><?php echo $row_Recordset1['fname'].' '.$row_Recordset1['lname']; ?></td>   
                    <td>
<?php  echo $row_Recordset2['remarks'];?>
                        </td>
<td><?php echo $row_Recordset2['charge']; ?></td>

<td><a href="bill_dre.php?pid=<?php echo $row_Recordset2['pid']; ?>&id=<?php echo $row_Recordset2['id'];?>" class="btn btn-info"><i class="fa fa-hospital-o"> Bill</i></a></td>
