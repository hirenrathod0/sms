...
function get_discount(dc) {
	if(dc == ""){
		...
		var total_dis = dc;
		var tt1= tt-total_dis;
		document.getElementById("total_d").innerHTML = tt1;
		document.getElementById("td_txt").value = tt1; 
	}
          ...
          <div class="col-lg-12">
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
				...
				<form name="genebill" method="get" action="hh.php">
				...
				<?php  	$i = 0;$total=0;  foreach($report_names as $report_name){
								...
								?>
										<tr>
											...
											<td> <a data-id="1" title="Remove" class="open-AddBookDialog btn btn-warning" href="ge1.php?pid=<?php  echo $report_name; ?>&l=<?php echo $_GET['pid']; ?>" style="height:auto;width:auto"><i class="fa fa-scissors"></i></a></td>
										</tr>
						<?php  $total += $bill_data['price']; }   ?>
				<?php } ?>	
				<tr><td colspan="2" align="right"><label>Total :</label></td>
							<td ><label><input type="text" value="<?php echo $total; ?>" id="total" disabled="disabled"/></label></td></tr> 
				<tr><td colspan="2" align="right"><label> Discount:</label></td>
					<td ><input type="text" name="discount" id="discount" style="width:50px;" onblur="get_discount(this.value);" value="0"><label></label></td>
				</tr>
				
				<tr><td colspan="2" align="right" ><label>Total after advance :</label></td>
