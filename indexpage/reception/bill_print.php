...
<div id="page-wrapper" style="padding-left:20%">
  <div class="page-content" >
    ...
    <table width="600" height="302"  >
      <tr>
        <td><div align="center"><strong>Bill Detail Sheet</strong></div></td>
      </tr>
      <tr>
        <td><hr/></td>
      </tr>
...
$totalRows_Recordset151 = mysql_num_rows($Recordset151);
			echo $row_Recordset151['fullname'];?></td>
...
?>
 ...
 $tt1=$tt1+$row_Recordset33['price']; }while($row_Recordset33 = mysql_fetch_assoc($Recordset33)); echo $tt;?></td>
              <td width="138"></td>
              <td width="263"><?php echo "WARD CHARGES -".$row_Recordset15['rtype'];
		 $mm=$row_Recordset15['rtype'];	?></td>
              <td width="262">&nbsp;</td>
              <td width="134"><?php
            ...
            <tr>
              <td><table width="780">
                  ...
                  <td width="399"><div align="right">Total Amount</div></td>
                    <form action="file_bill.php" method="get" >
                  
                  <td width="105"><input type="hidden" value="<?php echo $_GET['pid'];?>" name="pid" />
                    <div align="right">
                      <?php  $total=$rr+$qr+$zz+$yy5; ?>
                      <input type="hidden" value="<?php echo $total;?>" name="tt5" id="tt5" />
                      <input type="text" readonly="" value="<?php echo $total;?>" id="tt7" name="tt7" readonly="readonly" />
                    </div></td>
                    </tr>
                  
                  <tr>
                    <td height="24"><div align="right">Doctor & Nuring Charge @
                        <input type="text" class="input-mini" size="2" maxlength="2" id="per" name="per" value="" onblur="myFunction(this.value)" />
                        %</div></td>
                    <td><div align="right">
                        <?php //echo $tot=round(($total*15)/100); ?>
                        <input type="text" name="tt8" id="tt8"  readonly=""/>
                      </div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><div align="right">
                        <input type="text" readonly="" name="ft" id="ft" />
                      </div></td>
                  </tr>
                  <?php 
                    mysql_select_db($database_cn, $cn);
$query_Recordset381 = "SELECT * FROM `refund_dtl` WHERE pid='$pid'";
$Recordset381 = mysql_query($query_Recordset381, $cn) or die(mysql_error());
$row_Recordset381 = mysql_fetch_assoc($Recordset381);
$totalRows_Recordset381 = mysql_num_rows($Recordset381);
                     $ll=0;
                    ?>
                  <tr>
                    <td><div align="right">Less Deposit
                        <?php //echo $row_Recordset381['depo_date']; ?>
                      </div></td>
                    <td><div align="right">
                        <?php /*?><?php echo $row_Recordset381['depo_amt'];
						 ...
						 $ll=$ll+$row_Recordset381['depo_amt'];
						  ?><?php */?>
                        <input type="text"id="ft1" name="ft1" onblur="myFunction1(this.value)" />
                      </div></td>
                  </tr>
                  <tr>
                    <td colspan="2"><hr/></td>
                    ...
                    <td colspan="3"><div align="right" style="padding:10px;margin:10px;border:solid;width:350px;float:right">
                        <table width="315" height="28">
                          <tr>
                            ...
                            <td width="114"><div align="right"><strong>
                                <input type="text" name="tt10" id="tt10" readonly=""   />
                                </strong></div></td>
                          </tr>
                        </table>
                      </div></td>
                  ...
                  <tr>
                    <td colspan="3"><table width="880">
                        <tr>
                          <td width="58%" ><strong>USER NAME :
                            <input type="text" name="user_nm" value="Santosh" readonly="" />
                            </strong></td>
                        </tr>
                        <tr>
                          <td style="padding-left:70%"><input type="submit" value="PRINT" class="btn-danger btn"></td>
                        </tr>
                      </table></td>
                  </tr>
                </table></td>
