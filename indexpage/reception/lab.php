...
$insertSQL = sprintf("INSERT INTO labs (fname, mname, lname, bdate, city, contactno1, contactno2, emailid, gender,bgroup,iden_type,iden_no,religion,state,smoker,tobacco,alcohol,pincode,height,weight,adds,remark,mnm,gnm) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s,%s,%s,%s,%s)",
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h4 style="float:left"> New Lab </h4>
				  
                </div>
                <div class="portlet-widgets"> <a href="all_lab.php"  class="pull-right btn-orange btn "   > All Lab Data </a>   </div>
                  ...
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>" id="f1">
                    <table align="center" class="table-responsive table-condensed table-bordered table ">
                      <tr valign="baseline">
                        ...
                        <td><input type="text" name="fname" value="" size="30" placeholder="Enter First Name " class="form-control" onblur="makeupper(this.id);" id="fname"></td>
					  ...
					  <tr valign="baseline">
                        ...
                        <td><input type="text" name="gnm" value="" size="30" placeholder="Enter Grandfather Name"  class="form-control" id="gnm" onblur="makeupper(this.id);"></td>
                      ...
                      <tr valign="baseline">
                       ...
                       <td nowrap ><strong>Age:</strong></td>
						...
						<input type="text" name="bdate" onblur="makeupper(this.id);" value="" size="30" placeholder="Enter Age " class="form-control"> 
                      ...
                      <tr valign="baseline">
                        ...
                        <td><input type="text" name="weight" onblur="makeupper(this.id);" value="" size="30" placeholder="Enter Weight"  class="form-control" id="weight"></td>
                      ...
                      <tr valign="baseline">
                       ...
                       <td nowrap > <strong>Secondary Contact No (If Any) :</strong></td>
                        <td><input type="number" name="contactno2" id="contactno2" value="" size="30" placeholder="Secondary Contact No" class="form-control"></td> 
                      ...
                      <tr valign="baseline">
                        ...
                        <td> 
						 <select name="bgp" id="bgp1" class="form-control">   
