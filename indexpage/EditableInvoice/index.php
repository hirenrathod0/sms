...
<head>
	...
	<title>Nikhil Metal COrporation Invoice</title>
...
Phone: (555) 555-5555</textarea>
            ...
            <div id="logo">
              ...
              <img id="image" src="full_icon3.png" alt="logo" />
            </div>
...
c/o Steve Widget</textarea>
	...
	<FORM>
<div> <INPUT TYPE="submit" value="PRINT" onClick="window.print()" style="width:500px; margin-left:25%; margin-top:30px;  border-radius:30px;background-color:blue; color:white; height:50px" >  </div>
</FORM>
	</div>
