      ...
      <div class="col-lg-12">
        <div class="page-title">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Today Patients </li>
          </ol>
        </div>
      </div>
      <!-- /.col-lg-12 -->
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h4 style="float:left"> Today's Patients </h4>
                </div>
...
$Recordset1 = mysql_query($query_Recordset1, $cn) or die(mysql_error());
                      ...
                      <tr>
                        ...
                        <td><a data-id="1" title="Generate Report" class="open-AddBookDialog btn btn-info" href="generateReport.php?pid=<?php echo $row["pid"]; ?>&repName=<?php echo $row["GROUP_CONCAT(doc_lab_report.sel_rep_name SEPARATOR',')"]; ?>" style="height:auto;width:auto"><i class="fa fa-paperclip"> Generate Report</i></a>
                          <?php /*?><a data-id="1" title="Generate Bill" class="open-AddBookDialog btn btn-warning" href="generateBill.php?pid=<?php echo $row["pid"]; ?>&repName=<?php echo $row["GROUP_CONCAT(doc_lab_report.sel_rep_name SEPARATOR',')"]; ?>" style="height:auto;width:auto"><i class="fa fa-paperclip"> Generate Bill</i></a><?php */?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
