...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO rep_cat (name,price) VALUES (%s,%s)",
                    ...
                    <?php $i=1; do  { ?>
                      <tr>
                       <td><?php echo $i; ?></td>
						...
						<td><a href="editcat.php?bid=<?php echo $row_Recordset1['rid']; ?>"> <i class="fa fa-edit"></i> </a> </td>
						 <td><a href="delcat.php?bid=<?php echo $row_Recordset1['rid']; ?>"> <i class="fa fa-times">  </i> </a> </td>
					</tr>
