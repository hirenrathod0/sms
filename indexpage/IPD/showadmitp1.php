            ...
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  ...
                  <a data-id="SPECIAL"  rel="<?php echo $j ?>" class="btn btn-success spe abc" href="admitpp.php?pid=<?php echo $_GET['pid'] ?>&amp;rooms=SPECIAL&amp;id=<?php echo $j ?>">Room NO <?php echo $j ?> </a>
                  <?php }?>
                </div>
              </div>
            </div>
            ...
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  ...
                  <a data-id="ICU"  rel="<?php echo $j ?>" class="btn btn-success icu abc" href="admitpp.php?pid=<?php echo $_GET['pid'] ?>&amp;rooms=FEMALE WARD&amp;id=<?php echo $j ?>"> BED NO <?php echo $j ?> </a>
                  <?php
					}
					?>
                </div>
            ...
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  ...
                  <a data-id="ICU1"  rel="<?php echo $jj ?>" class="btn btn-success icu1 abc" href="admitpp.php?pid=<?php echo $_GET['pid'] ?>&amp;rooms=MALE WARD&amp;id=<?php echo $jj ?>"> BED NO <?php echo $jj ?> </a>
                  <?php
					}
					?>
                </div>
