...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "updateuser")) {
  ...
  $updateGoTo = "../nurse_female/listuser.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb">
                                <li><i class="fa fa-dashboard"></i>  <a href="../nurse_female/index.phpl">Home</a>                                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="tab-pane fade in active" id="overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4">
												...
												<?php echo $row_useroverview_rs['address']; ?>
												
												</p>
                                               <p><i class="fa fa-building-o fa-muted fa-fw"></i>
												<?php echo $row_useroverview_rs['city']; ?></p>
                      ...
                      <label for="exampleInputEmail1">Gender </label>
 					  	...
 					  	<input type="radio" name="gender" value="Male" <?php if(!(strcmp($row_useroverview_rs['gender'],"MALE"))){ echo 'CHECKED'; } ?> />MALE
					  	<input type="radio" name="gender" Value= "Female"  <?php if(!(strcmp($row_useroverview_rs['gender'],"FEMALE"))){ echo 'CHECKED'; } ?> />FEMALE
											...
											<textarea name="address" class="form-control" cols="15" id="add"onblur="makeupper(this.id);" rows="3"><?php echo $row_useroverview_rs['address']; ?></textarea>
                                                            ...
                                                            <div class="form-inline">
                                                                <div class="form-group">
                                                                    <label>City</label>
                                                                 <input type="text" name="city" id="city"onblur="makeupper(this.id);" class="form-control" value="<?php echo $row_useroverview_rs['city']; ?>">   </div>
...
?>
								  ...
								  <img class="img-responsive img-profile" src="../userpic/<?php echo $row_useroverview_rs['img']; ?>" alt="">
