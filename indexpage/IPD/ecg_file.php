...
$query_Recordset1 = "SELECT * FROM fee where name='ECG'";
$Recordset1 = mysql_query($query_Recordset1, $cn) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
$ii=$row_Recordset1['price'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $insertSQL = sprintf("INSERT INTO ecg (pid,pdfname,price) VALUES ('$hh',%s,'$ii')",
                       GetSQLValueString($_FILES['pdfname']['name'], "text"));
					   
					   
					    move_uploaded_file($_FILES['pdfname']['tmp_name'],'ecg/'.$_FILES['pdfname']['name']);

  mysql_select_db($database_cn, $cn);
  $Result1 = mysql_query($insertSQL, $cn) or die(mysql_error());

  $insertGoTo = "btndtl.php";
  if (isset($_SERVER['QUERY_STRING'])) {
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-title">
              ...
              <?php 
              mysql_select_db($database_cn, $cn);
$query_Recordset1h = "SELECT * FROM patient where pid='$hh'";
                ...
                <div class="portlet portlet-default">
                  <div class="portlet-heading">
                    <div class="portlet-title">
                      <h4 style="float:left"> Upload PDF of Patient</h4>
                    </div>
                      ...
                      <form method="POST" name="form1" action="<?php echo $editFormAction; ?>" id="f1" enctype="multipart/form-data">
                        <table align="center" class="table-responsive table-condensed table-bordered table ">
                          <tr valign="baseline">
                            ...
                            <td><input type="file" name="pdfname" value="" size="32" required="required">
                              (*PDF File Only)</td>
                          </tr>
                          <tr valign="baseline">
