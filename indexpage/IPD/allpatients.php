...
$query_Recordset2 = "SELECT * FROM patient where type='Emergency Fee' and gender='Female'";
...
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
 ?>
 					 <td><?php echo $i; ?></td>
                        ...
                        <td><?php /*?><a data-id='<?php echo $row_Recordset2['pid']; ?>'  title="Add this item" class="open-AddBookDialog btn btn-success" href="#myModal" style="height:auto;width:auto"><i class="fa fa-paperclip">Details</i></a> <?php */?>
						<a href="booking.php?pid=<?php echo $row_Recordset2['pid']; ?>" class="btn btn-warning"><i class="fa fa-lemon-o">Booking</i></a> 
						
						<?php /*?><a href="del_pat.php?pid=<?php echo $row_Recordset2['pid']; ?>" class="btn btn-danger"><i class="fa fa-times"> Delete</i></a> <?php */?>
						
						<a href="admit.php?pid=<?php echo $row_Recordset2['pid']; ?>" class="btn btn-info"><i class="fa fa-hospital-o">Admit</i></a> </td>
                      </tr>
