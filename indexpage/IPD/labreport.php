  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="page-title">
        <h1> <?php echo $row_Recordset11['fname']."  ".$row_Recordset11['mname']."  ".$row_Recordset11['lname'] ; ?> 
