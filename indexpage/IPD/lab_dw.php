...
header('login.php');
 ...
 $ss=$_SESSION['MM_Nurse'];

mysql_select_db($database_cn, $cn);
$query_Recordset1 = "SELECT * FROM doc_lab_report join patient on patient.pid=doc_lab_report.pid  where docid='$ss' group by doc_lab_report.pid order by doc_lab_report.pid desc";
...
?>
	...
	if($k=="MALE")  {echo ("M"); } else  { echo("F");}?></td>
                      ...
                      <td><a href="lab_rep.php?pid=<?php echo $row_Recordset1['pid']?>" class="btn btn-warning">View Reports</a></td>
                      </tr>
