...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add-medicine")) {
  $insertSQL = sprintf("INSERT INTO medicine (mtid, name, strength, dosage, manufcuturer, genericname, remarks, extra) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['mtid'], "int"),
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['strength'], "text"),
                       GetSQLValueString($_POST['dosage'], "int"),
  ...
  $insertGoTo = "../nurse_female/editmedicine.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
?>
                    ...
                    <tr valign="baseline">
                      ...
                      <td><input type="text" name="name" required class="form-control" onblur="makeupper(this.id);" id="mnm" placeholder="Enter Medicine Name"> </td>
                    </tr>
                     <tr valign="baseline">
                      <td nowrap align="left"><strong> Strength:</strong></td>
                      <td><input type="text" name="strength" class="form-control" required onblur="makeupper(this.id);" id="st" placeholder="Enter Strength">
                      </td>
                    </tr>
                    
					<tr valign="baseline">
                      <td nowrap align="left"><strong> Dosage:</strong></td>
                      <td><input type="text" name="dosage" class="form-control" required onblur="makeupper(this.id);" id="dosage" placeholder="Enter Dosage">
                      </td>
                    </tr>
					<tr valign="baseline">
                      <td nowrap align="left"><strong> Manufacturer:</strong></td>
                      <td><input type="text" name="manufcaturer" class="form-control" required onblur="makeupper(this.id);" id="manu" placeholder="Enter Manufacturer">
                      </td>
                    </tr>
					...
					<tr valign="baseline">
                      ...
                      <td><input type="text" name="genericname" class="form-control" required onblur="makeupper(this.id);" id="gnm" placeholder="Enter Genaric Name"> </td>
                    </tr>
				    	<tr valign="baseline">
                      <td nowrap align="left"><strong>Remarks:</strong></td>
                      <td><textarea name="remarks" onblur="makeupper(this.id);"  id="rm" class="form-control" placeholder="Remarks(If Any)" cols="15" rows="5" ></textarea> </td>
                    </tr>
					<tr valign="baseline">
