...
$query_Recordset1 = "SELECT * FROM xray_bill join patient on patient.pid=xray_bill.pid where gender='Female'";
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  ...
                  <table id="example-table" class="table table-striped table-bordered table-hover table-green">
                    ...
                    <tbody>
                      <?php $i=1;do { 
					  $rr=$row_Recordset1['pid'];
					  mysql_select_db($database_cn, $cn);
$query_Recordset2 = "SELECT * FROM patient where pid='$rr'";
...
?>
                      ...
                      <td><?php echo $i;?></td>
                        ...
                        <td><?php echo $row_Recordset2['fname'].' '. $row_Recordset2['mname'].' '. $row_Recordset2['lname']; ?>&nbsp; </td>
                  <td><?php echo $row_Recordset2['bdate']; ?></td>
                  <td><?php echo $row_Recordset2['city']; ?>&nbsp; </td>
                     <td><?php $k=$row_Recordset2['gender']; 
	if($k=="MALE")  {echo ("M"); } else  { echo("F");}?></td>
                      <td><?php echo $row_Recordset2['contactno1'];
					$vv=$row_Recordset1['id'];
					  
	mysql_select_db($database_cn, $cn);
$query_rs_photo = "SELECT * FROM xray_photo where xid='$vv'";
$rs_photo = mysql_query($query_rs_photo, $cn) or die(mysql_error());
$row_rs_photo = mysql_fetch_assoc($rs_photo);
$totalRows_rs_photo = mysql_num_rows($rs_photo);				  
					  
					  ?></td>
                      <td>
                      <?php if($totalRows_rs_photo>0)
					  { do{?>
      <table class="table" style="border:none">
      
     <tr><td><?php echo $row_rs_photo['photo'];?></td><td class="pull-right"><a href="download.php?filename=<?php echo $row_rs_photo['photo']; ?>" class="btn btn-info"><i class="fa fa-paperclip">Download</i></a></td></tr>
     </table>
