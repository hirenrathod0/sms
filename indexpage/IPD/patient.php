...
$insertSQL = sprintf("INSERT INTO patient (fname, mname, lname, bdate, city, contactno1, contactno2, emailid, gender, bgroup, iden_no, iden_type, religion, state, smoker, tobacco, alcohol, pincode, height, weight, adds, remark, mnm, gnm,type,case_fee) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s)",
          ...
          <div class="col-lg-12">
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                ...
                <div class="portlet-widgets"> <a href="allpatients.php"  class="pull-right btn-orange btn "   > All Patients </a> <?php /*?><a href="follow_up.php"  class="pull-right btn-danger btn "   > Follow up Patients </a><?php */?> </div>
...
$totalRows_Recordset111 = mysql_num_rows($Recordset111);
		...
		?>
                      ...
                      <tr valign="baseline">
                        ...
                        <td><input type="number" name="contactno2" id="contactno2" value="" size="70" placeholder="Secondary Contact No" class="form-control"></td>
                      </tr>
                      <tr valign="baseline">
...
?>
                      ...
                      <tr valign="baseline">
                        <td nowrap colspan="4"><strong> Smoker:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          ...
                          <input type="checkbox" name="alcohol" id="alcohol" ></td>
                      </tr>
                      <tr valign="baseline" >
