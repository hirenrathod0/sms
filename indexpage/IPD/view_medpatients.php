...
?></td>
                        ...
                        <?php /*?>  <a data-id='<?php echo $row_Recordset1['pid']; ?>'  title="Add this item" class="open-AddBookDialog1 btn btn-warning" href="#myModal1" style="height:auto;width:auto"><i class="fa fa-paperclip"> Certificate</i></a> 
                    ...
                    <?php */?>
                         ...
                         <?php /*?> <a href="pexamination-1.php?pid=<?php echo $row_Recordset1['pid']; ?>" class="btn btn-info "><i class="fa fa-paperclip">Examination</i></a><?php */?>
