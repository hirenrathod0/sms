...
if(isset($_POST['MM_Examination'])){
	...
	$insertQuery5 = "INSERT INTO e_cardio_system(exid,precedium,visible_pulsation,apex_beat,parasternal,impulse,RHB,LHB,ICS,auscultation)VALUES('".$_GET['pid']."','".$_POST['insp_precedium']."','".$_POST['insp_pulsation']."','".$_POST['palp_AB']."','".$_POST['palp_para']."','".$_POST['palp_impulse']."','".$_POST['resp_RHB']."','".$_POST['resp_LHB']."','".$_POST['resp_ICS']."','NULL')";
		...
		mysql_select_db($database_cn, $cn);
	    $insertQuery6 = "INSERT INTO e_alimentary_system(exid,inspection,palpation,percussation,auscultation,external_genetalia,rectal_exam,musc_hands,musc_elbow,musc_shoulder,musc_back,musc_hip,musc_knee,musc_foot)VALUES('".$_GET['pid']."','".$_POST['alim_insp']."','".$_POST['alim_palp']."','".$_POST['alim_percu']."','".$_POST['alim_ausc']."','".$_POST['alim_genifi']."','".$_POST['alim_rectal']."','".$_POST['alim_musc_hands']."','".$_POST['alim_musc_elbow']."','".$_POST['alim_musc_shoulder']."','".$_POST['alim_musc_back']."','".$_POST['alim_musc_hip']."','".$_POST['alim_musc_knee']."','".$_POST['alim_musc_foot']."')";
		...
		mysql_select_db($database_cn, $cn);
	    $insertQuery8 = "INSERT INTO e_sensory_system(exid,touch,temperature,joint_position,cortical_sensation,cerebillium,
	...
	mysql_select_db($database_cn, $cn);
	$insertQuery9 = "INSERT INTO e_other_data(exid,ECG,RBUS,Xray,USG,echo,CM) VALUES('".$_GET['pid']."','".$_POST['ECG']."','".$_POST['RBS']."','".$_POST['x-ray']."','".$_POST['USG']."','".$_POST['echo']."','".$_POST['CT']."')";
...
mysql_select_db($database_cn, $cn);
	...
	mysql_select_db($database_cn, $cn);
		...
		mysql_select_db($database_cn, $cn);
	    $insertQuery8 = "UPDATE e_sensory_system SET touch='".$_POST['SS_pain']."',temperature='".$_POST['SS_temp']."',joint_position='".$_POST['SS_vibration']."',cortical_sensation='".$_POST['SS_CS']."',cerebillium='".$_POST['SS_CG']."',
	...
	mysql_select_db($database_cn, $cn);
	$insertQuery9 = "UPDATE e_other_data SET ECG='".$_POST['ECG']."',RBUS='".$_POST['RBS']."',Xray='".$_POST['x-ray']."',USG='".$_POST['USG']."',echo='".$_POST['echo']."',CM='".$_POST['CT']."' WHERE exid='".$_GET['pid']."'";
		mysql_query($insertQuery9, $cn) or die(mysql_error());
}	
      ...
      <div class="col-lg-9">
        <div class="portlet portlet-default">
          <div class="portlet-heading">
            ...
            <div class="portlet-widgets"> <a href="../nurse_female/examPDF.php?pid=<?php echo $_GET["pid"];?>"  class="pull-right btn-orange btn "   > Generate PDF </a> </div>
						...
						<div class="tab-pane active" id="problems">
								<div class="portlet-body">
									 <table class="table table-striped table-bordered table-hover table-green">
									  ...
									  <tr>
										<td><textarea id="complaints" name="complaints"></textarea></td> 								  </tr>
									 <script type="text/javascript">
									  ...
									  <tr>
										<td><textarea id="past_data" name="past_data"></textarea></td>
									  </tr>
									  <script type="text/javascript">
									 	CKEDITOR.replace('past_data');
									 </script>
									  <tr>
										<td><label>Family History</label></td>
									  </tr>
									  <tr>
										<td><textarea id="family_data" name="family_data"></textarea></td>
									  </tr>
									  <script type="text/javascript">
									 	CKEDITOR.replace('family_data');
									 </script>
									  <tr>
										<td><label>Personal Habit :Smoking/Alcohol etc.</label></td>
									  </tr>
									  <tr>
										<td><textarea id="habit_data" name="habit_data"></textarea></td>
									  </tr>
									  <script type="text/javascript">
									 	CKEDITOR.replace('habit_data');
									 </script>
									  <tr>
										<td><label>Obs/Gyn History</label></td>
									  </tr>
									  <tr>
										<td><textarea id="OG_data" name="OG_data"></textarea></td>
									  </tr>
									  <script type="text/javascript">
									 	CKEDITOR.replace('OG_data');
									 </script>
									  <tr>
										<td><label>Adverse Drug Reaction</label></td>
									  </tr>
									  <tr>
										<td><textarea id="reaction_data" name="reaction_data"></textarea></td>
									  </tr>
									  <script type="text/javascript">
									 	CKEDITOR.replace('reaction_data');
									 </script>
									  <tr>
										<td><label>Personal Drugs</label></td>
									  </tr>
									  <tr>
										<td><textarea id="personal_drug_data" name="personal_drug_data"></textarea></td>
									  </tr>
									  <script type="text/javascript">
									 	CKEDITOR.replace('personal_drug_data');
									 </script>	
									 <tr>
									 	<td><a href="#" id="next" class="btn-info btn pull-right" align="middle" style="margin-right:20px; width:70px;">Next</a>
										</td>
									 </tr>					 
									 </table>
    ...
    <div id="collapseOne" class="accordion-body collapse">
      <div class="accordion-inner">
		...
		<tr><td><label>Percussaion:</label></td>
			<td></td>
			<td><input name="resp_percussation" type="text" value="<?php echo ($row_c > 0) ? $row['percussation']: "";?>"/></td></tr>
		<tr><td><label>Auscultation :</label></td>
			<td></td>
			<td><input name="resp_ausc" type="text" value="<?php echo ($row_c > 0) ? $row['auscultation']: "";?>"/></td>
		</tr>
      ...
      <div class="accordion-inner">
		...
		<table class="table table-striped table-bordered table-hover table-green">
		  ...
		  <tr>
			...
			<td><input name="ausc_ma_s1" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ma_s2" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ma_s3" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ma_s4" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ma_mar" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ma_click" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
		  </tr>
		  <tr>
			<th scope="row"><label>TA</label></th>
			<td><input name="ausc_ta_s1" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ta_s2" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ta_s3" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ta_s4" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ta_mar" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_ta_click" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
		  </tr>
		  <tr>
			<th scope="row"><label>AA</label></th>
			<td><input name="ausc_aa_s1" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_aa_s2" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_aa_s3" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_aa_s4" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_aa_mar" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_aa_click" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
		  </tr>
		  <tr>
			<th scope="row"><label>PA</label></th>
			<td><input name="ausc_pa_s1" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_pa_s2" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_pa_s3" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_pa_s4" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_pa_mar" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
			<td><input name="ausc_pa_click" type="text" class="small-input" value="<?php echo ($row_c > 0) ? $row['vital_data']: "";?>"/></td>
		  </tr>
		</table>
...
<tr>
	...
	<a href="#" id="next3" class="btn-info btn pull-right" >Next</a>
										<a href="#" id="prev3" class="btn-info btn"  >Previous</a>
</div>
</div>
