...
$lnm=$_POST['lname'];
$age=$_POST['age'];
$dt=$_POST['surgery_date'];

//mysql_connect('localhost','root','');
//mysql_select_db('doc_connect');
  $query="INSERT INTO `death`( `pid`, `fname`, `lname`, `sur_dt`) VALUES ('$pid','$fnm','$lnm','$dt')";

if(mysql_query($query))
{
echo $id= mysql_insert_id();  
header('location:temp_death.php?pid='.$pid);
}
}
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-title">
          <h1> Enter Details For Death Certificate </h1>
          <ol class="breadcrumb">
...
?>
                    ...
                    <table  class="table table-striped table-bordered table-hover table-green">
                      <tr>
                        ...
                        <td><input type="date"  name="surgery_date" size="48"></td>
                      </tr>
                      <tr>
