...
//mysql_connect('localhost','root','');
//mysql_select_db('doc_connect');
  $query="INSERT INTO `fitness`( `pid`, `fname`, `lname`,  `sur_dt`) VALUES ($pid,'$fnm','$lnm','$dt')";
//exit;
...
<table  class="table table-striped table-bordered table-hover table-green">
						 ...
						 <tr>
						<td><strong>Examine Date  : </strong></td><td><input type="date"  name="surgery_date" size="48"></td>
						</tr>
