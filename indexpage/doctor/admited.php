...
mysql_select_db($database_cn, $cn);
$query_semispe = "SELECT * FROM subcategory WHERE name = 'SEMI-SPECIAL'";
...
mysql_select_db($database_cn, $cn);
$query_admsemispe = "SELECT * FROM patient_admit WHERE rtype = 'SEMI-SPECIAL'";
...
mysql_select_db($database_cn, $cn);
$query_admicu = "SELECT * FROM patient_admit WHERE rtype = 'ICU'";
      ...
      <div class="col-lg-12">
        <div class="row">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                ...
                <div class="portlet-body">
                  <?php  for($j = 1; $j <= $row_special["no_of"]; $j++){  ?>
                     <a data-id="SPECIAL"  rel="<?php echo $j ?>" class="btn btn-success spe abc" href="#">Room NO <?php echo $j ?>  </a> 
               <?php
					}
					?>
          ...
          <!-- SEMI-SPECIAL START -->
                  ...
                  <?php $i=1;  for($m = 1; $m <= $row_semispe["no_of"]; $m++){  
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h4 style="float:left">Semi-Special Room No <?php echo $i; ?></h4>
                </div>
                <div class="portlet-widgets">  </div>
                <div class="clearfix"></div>
              </div>
              <div id="basicFormExample" class="panel-collapse collapse in">
				  <div class="portlet-body">
				  <a data-id="SEMI-SPECIAL"  rel="<?php echo $m ?>" class="btn btn-success semi abc" href="#">Bed NO <?php echo $m ?>  </a> 
                   <a data-id="SEMI-SPECIAL"  rel="<?php echo $m+1 ?>" class="btn btn-success semi abc" href="#">Bed NO <?php echo $m+1 ?>  </a> 
            </div>
             </div>
            </div>
             </div>    
          ...
          <!-- SEMI-SPECIAL END -->
           <!-- ICU START -->
            ...
            <div class="portlet portlet-default">
              <div class="portlet-heading">
                <div class="portlet-title">
                  <h4 style="float:left">ICU Room</h4>
                </div>
                <div class="portlet-widgets">  </div>
                <div class="clearfix"></div>
              </div>
              <div id="basicFormExample" class="panel-collapse collapse in">
                ...
                <div class="portlet-body">
                  ...
                  <a data-id="ICU"  rel="<?php echo $j ?>" class="btn btn-success icu abc" href="#">ICU NO <?php echo $j ?>  </a>
