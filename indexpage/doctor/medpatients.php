...
if(isset($_POST['add_medicine'])){
    ...
    $insertSQL = sprintf("INSERT INTO p_medicine (mid,pid,did,noofdays,dosage,quantity) VALUES (%s,%s, %s, %s, %s, %s)",
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title>Medicine-Vihar Hospital</title>
...
?>
		...
		$query_Recordset2 = "SELECT * FROM p_medicine JOIN medicine ON medicine.mid=p_medicine.mid WHERE status='0' and  pid=".$_GET['pid'];
