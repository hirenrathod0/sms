...
$query_Recordset1 = "SELECT * FROM follow group by pid ";
...
?></td>
						  ...
						  else
						  {
						   ...
						   ?></td>
                          <td style="width:50%" align="center"><a class="btn-success btn" href="view_history.php?pid=<?php echo $row_Recordset1['pid']; ?>" style="height:auto;width:auto"> View History</a>
	<a class="btn-blue btn" href="followp.php?pid=<?php echo $row_Recordset1['pid']; ?>" style="height:auto;width:auto">Follow Up</a>
						   <a data-id='<?php echo $row_Recordset1['pid']; ?>' title="Add this item" class="open-AddBookDialog1 btn-danger btn" href="#myModal1" style="height:auto;width:auto"> Certificate</a>						    							
							</td>
                        </tr>
