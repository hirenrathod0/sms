...
$query_Recordset1 = "SELECT * FROM xray_bill";
...
?>
	...
	mysql_select_db($database_cn, $cn);
$query_rs_photo = "SELECT * FROM con_photo where id='$vv'";
...
$totalRows_rs_photo = mysql_num_rows($rs_photo);				  
     ...
     <tr><td><?php echo $row_rs_photo['pdfname'];?></td><td class="pull-right"><a href="download1.php?filename=<?php echo $row_rs_photo['pdfname']; ?>" class="btn btn-info"><i class="fa fa-paperclip">Download</i></a></td></tr>
     </table>
