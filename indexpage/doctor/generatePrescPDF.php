...
//$pdf->Image('img/b4.png',165,70,'L',0);
$pdf->Image('img/b2.png',122,72);
$pdf->Image('img/b1.png',137,72);
$pdf->Image('img/b3.png',151,72);
$pdf->Image('img/b4.png',165,72);
...
while($row_getmedicine = mysql_fetch_assoc($getmedicine)){
	...
	$pdf->Cell(23,6,$row_getmedicine["strength"],0,0,'L',0);
	//$pdf->Cell(60,6,$row_getmedicine["dosageM"]."-".$row_getmedicine["dosageA"]."-".$row_getmedicine["dosageE"]."-".$row_getmedicine["dosageN"],0,0,'L',0);
	$pdf->Cell(15,6,$row_getmedicine["dosageM"],0,0,'L',0);
	$pdf->Cell(15,6,$row_getmedicine["dosageA"],0,0,'L',0);
	$pdf->Cell(14,5,$row_getmedicine["dosageE"],0,0,'L',0);
	$pdf->Cell(14,5,$row_getmedicine["dosageN"],0,0,'L',0);
