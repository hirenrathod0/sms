...
?>
                      <tr>
                        ...
                        <td><?php echo $row_Recordset2['fname'].' '.$row_Recordset2['mname'].' '.$row_Recordset2['mname']; ?>&nbsp; </td>
	...
	mysql_select_db($database_cn, $cn);
$query_rs_photo = "SELECT * FROM ecg where id='$vv'";
...
$totalRows_rs_photo = mysql_num_rows($rs_photo);				  
     ...
     <tr><td><?php echo $row_rs_photo['pdfname'];?></td><td class="pull-right"><a href="download2.php?filename=<?php echo $row_rs_photo['pdfname']; ?>" class="btn btn-info"><i class="fa fa-paperclip">Download</i></a></td></tr>
     </table>
