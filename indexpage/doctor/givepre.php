...
$query_getmlist = "SELECT medicine.mid, medicine.mtid, medicine.name, medicine.strength, medicine.dosage, medicine.manufcuturer, medicine.genericname, medicine.extra, medicinetype.name as mtype FROM medicine JOIN medicinetype ON medicine.mtid=medicinetype.mtid where medicine.mid='$colname_getmlist'";
}
...
if(isset($_POST['add_days'])){
	...
	header("location:givepre.php?pid=".$_POST["pid"]."&nn=".$_POST["nofdy"]);
}
...
<title>Prescription-Vihar Hospital</title>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-title">
          <h1> <?php echo $row_patient['fname']."  ".$row_patient['mname']."  ".$row_patient['lname'] ; ?> </h1>
                      ...
                      <table>
                        <tr>
                          <td><input type="hidden" name="pid" value="<?php echo $_GET['pid']?>" />
                            <input type="text" name="nofdy" value="<?php echo (isset($_GET['nn'])) ? $_GET['nn'] : "" ; ?>" class="input-mini" style="width:90px;" required/></td>
                          <td>&nbsp;
                            <button type="submit" class="btn btn-success" name="add_days">Add</button></td>
                        </tr>
                      </table>
                    </form>
                  </div>
...
?>
                      ...
                      <tr>
                        <td>Manufacturer</td>
                        <td><label><?php echo $row_getmlist['manufcuturer']; ?></label></td>
                      </tr>
                      <tr>
                        <td>Generic Name</td>
                        <td><label><?php echo $row_getmlist['genericname']; ?></label></td>
                      </tr>
                      <tr>
                        <td>Medicine Form</td>
                        <td><label><?php echo $row_getmlist['mtype']; ?></label></td>
                      </tr>
                      <tr>
                        <td>Strength</td>
                        <td><input type="text"  class="form-control"  name="strength" value="<?php echo $row_getmlist['strength']; ?>"/></td>
                      </tr>
                      <tr>
                        <td>Dosage</td>
                        <td><table class="table table-bordered" >
                            ...
                            <tr>
                              ...
                              <td>N</td>
                              <td><input type="number" class="form-control" name="dosageN" value="<?php echo $row_getmedicine['dosageN']; ?>"/></td>
                            </tr>
                          </table></td>
                      <tr>
                        <td>Dosage Timing</td>
                        <td><input type="text" name="dosage" class="form-control" value="<?php echo $row_getmlist['dosage']; ?>" onblur="makeupper(this.id);" id="dosage1" placeholder="Enter Dosage"></td>
                      </tr>
                      <tr>
   ...
   $row_getmedicine['dosageN']); ?></td>
                          ...
                          <td><?php $nd=($row_getmedicine['qty']/($row_getmedicine['dosageM'] +$row_getmedicine['dosageA'] +$row_getmedicine['dosageE'] + $row_getmedicine['dosageN'])); ?>
                            ...
                            <button type="button" class="btn btn-danger" onclick="getc(<?php echo $row_getmedicine['pmid']; ?>,<?php echo $_GET['pid']; ?>)"><i class="fa fa-times"></i></button></td>
                        </tr>
                        <?php } while ($row_getmedicine = mysql_fetch_assoc($getmedicine)); ?>
                      <tr>
                        <td colspan="7" align="center"><button id="gen_prescp" type="submit" name="edit" class="btn btn-default">Generate Prescription</button></td>
                      </tr>
                    </table>
                  </form>
