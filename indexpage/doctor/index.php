...
$query_Recordset11 = "SELECT * FROM `booking` WHERE docid='$k' and date(bdt)='$n' ";  
...
?></td>
                       ...
                       <a class="btn-success btn" href="btndtl.php?pid=<?php echo $row_Recordset1['pid']; ?>" style="height:auto;width:auto">Report</a>   
                        ...
                        <?php $i++;} while ($row_Recordset11 = mysql_fetch_assoc($Recordset11)); ?>
                    </tbody>
                  </table>
                  <?php } else {  ?>
