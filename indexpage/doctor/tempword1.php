...
$query_Recordset1 = sprintf("SELECT * FROM fitness WHERE pid = %s", $colname_Recordset1);
...
//$pd=$_GET['pid'];
mysql_select_db($database_cn, $cn);
 $query_Recordset11= sprintf("SELECT * FROM patient WHERE pid ='$ll' ");
...
//<table border='1' bordercolor='#000000' width='100%' border='solid'>
//             
//
//
//  <tr>
