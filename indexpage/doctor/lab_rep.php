...
mysql_select_db($database_cn, $cn);
   $query_Recordset11 = "SELECT * FROM doc_lab_report where pid='$cc' and docid='$k'";
  //exit;
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  ...
                  <table id="example-table" class="table table-striped table-bordered table-hover table-green">
					...
					?>
                        <tr>
          <td><?php echo $row_Recordset11['sel_rep_name'];?></td>
          <td><?php echo $row_Recordset11['reading'];?></td> 
          <td><?php $ss1=$row_Recordset11['sel_rep_name'];
		  
		  $qq5=mysql_query("select * from rep_cat where name='$ss1'");
		  $qq6=mysql_fetch_assoc($qq5);
		  $aa=$qq6['rid'];
		  
		  $qq=mysql_query("select * from reportdata where cid='$aa'");
		  $qq1=mysql_fetch_assoc($qq);
		  echo $qq1['normalvalue'];
