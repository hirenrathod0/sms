        ...
        <div class="row"> 
                ...
                <div class="portlet-body">
                  <table style="overflow:auto;width:100%" class="table-bordered table-condensed table-green table-hover table-responsive table">
                    ...
                    <?php do { ?>
                      ...
                      <tr>
                        <td colspan="11"><a href="admitme.php?pid=<?php echo $row_patient['pid']; ?>" class="btn-dark-blue btn"> Admit </a></td>
                      </tr>
          ...
          <div class="col-lg-3">
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body"> <a data-id="SEMI-SPECIAL"  rel="<?php echo $m ?>" class="btn btn-success semi abc" href="#">Bed NO <?php echo $m ?> </a> <a data-id="SEMI-SPECIAL"  rel="<?php echo $m+1 ?>" class="btn btn-success semi abc" href="#">Bed NO <?php echo $m+1 ?> </a> </div>
              </div>
            </div>
          </div>
          <?php $m++;$i++; }?>
            ...
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  ...
                  <a data-id="ICU"  rel="<?php echo $j ?>" class="btn btn-success icu abc" href="#"> BED NO <?php echo $j ?> </a>
                  <?php
					}
					?>
                </div>
          ...
          <div class="col-lg-12">
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  <?php for($jj = 1; $jj <= $row_ICU["no_of"]; $jj++){  ?>
                  <div style="display:none;position:absolute;width:30%;height:20%;" class="mm" id="mm2"></div>
                  <a data-id="ICU1"  rel="<?php echo $jj ?>" class="btn btn-success icu1 abc" href="#"> BED NO <?php echo $jj ?> </a>
                  <?php
					}
					?>
                </div>
        ...
        $(document).ready(function () {
            ...
            $(".btn-danger").popoverasync({
                "placement": "bottom", "trigger": "hover", "title": "Patient Detail", "html": true, "content": function (callback, extensionRef) {
   					 $rtyp=$(this).data('id');
                     $id = $(this).attr("rel");
					 $.get("getdetail.php", {bedno:$id,rtype:$rtyp}, function (data) {
