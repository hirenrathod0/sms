...
mysql_select_db($database_cn, $cn);
 $query_Recordset2 = "SELECT * FROM patient_admit WHERE status = 'Discharge' ";
...
$totalRows_Recordset3 = mysql_num_rows($Recordset3);
					 ...
					 ?>
                      ...
                      <td><?php echo $row_Recordset3['bdate']; ?></td>
                        <td><?php echo $row_Recordset3['city']; ?></td>
                        <td><?php echo $row_Recordset2['gender']; ?></td>
						
						<td><?php echo date("d/m/Y",strtotime($row_Recordset2['dofadmit'])); ?></td>
						
						
                        <td>
                     
                        <a data-id='<?php echo $row_Recordset2['pid']; ?>'  title="Add this item" class="open-AddBookDialog btn btn-success" href="#myModal" style="height:auto;width:auto"><i class="fa fa-paperclip">Details</i></a> 
