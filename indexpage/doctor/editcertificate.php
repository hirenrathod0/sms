...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "adduser")) {
  $updateSQL = sprintf("UPDATE certificate SET name=%s WHERE id=%s",
...
mysql_select_db($database_cn, $cn);
$query_Recordset1 = sprintf("SELECT * FROM certificate WHERE id = %s", $colname_Recordset1);
            ...
            <div class="portlet portlet-default">
              ...
              <div id="basicFormExample" class="panel-collapse collapse in">
                <div class="portlet-body">
                  <form method="POST" action="<?php echo $editFormAction; ?>"  name="adduser" enctype="multipart/form-data" >
                    <table align="center" class="table-responsive table-condensed table-bordered table ">
                    <tr valign="baseline">
                      <td nowrap align="left"><strong> Name :</strong></td>
                      <td><input type="text" class="form-control" name="cate" onblur="makeupper(this.id);" id="exampleInputEmail1" required placeholder="Enter Certificate" value="<?php echo $row_Recordset1['name']; ?>"></td>
                    </tr>
                    ...
                    <input type="hidden" name="ids" value="<?php echo $row_Recordset1['id']; ?>">
